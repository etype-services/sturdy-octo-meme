...
if (isset($_POST['submit'])) {
    ...
    if ($response12->GetPublicationIDResult == -9) {
        ...
        if ($response12->GetPublicationIDResult == 3364) {
            $param = array(
                'UserName' => "$username",
                'Password' => "$Password"
            );
            ...
            if ($response->ValidateSubscriberResult == -1) {
                $msg = "Your Subscription has been expired  <a href='https://etypeservices.com//Subscriber/SignIn.aspx?IssueID=110585&ReturnUrl=https://etypeservices.com//Subscriber/ReSubscribe.aspx?PubID=3364'>Click here</a>  to re-subscribe.";
            }
            else {
                global $user;
                if ($user->uid == 0) {
...
<section class="container">
    ...
    <div class="login-help" style="color:#000">
        <p style="color:#000">Forgot your password? <a href="/forgot-password-0"
