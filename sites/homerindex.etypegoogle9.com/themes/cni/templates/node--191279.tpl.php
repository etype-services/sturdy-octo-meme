...
$param12=array('UserName'=>"$username");
    ...
    else if($response12->GetPublicationIDResult== 3191)
    {
...
{
   $msg="Your Subscription has been expired  <a href='https://etypeservices.com//Subscriber/SignIn.aspx?IssueID=103864&ReturnUrl=https://etypeservices.com//Subscriber/ReSubscribe.aspx?PubID=3191'>Click here</a>  to re-subscribe.";
}
else
{
  global $user;
